// Shared lightweight client-side logger. Include this via a script tag in both apps.
// Enable debug: localStorage.setItem('clientDebug','1'); disable: localStorage.removeItem('clientDebug');
(function(global){
